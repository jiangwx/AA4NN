...
void AA_Darknet19()
{
    Darknet_init();
    load_DNet();
    load_fm(conv16_blob,DNet[conv16], Name);
    AA_add(conv16_blob,conv16_AA,DNet[conv16]);
 ...
 *     Darknet_init();
    ...
    //load_fm(conv2_blob,DNet[conv2], Name);
    //AA_add(conv2_blob,conv2_AA,DNet[conv2]);
